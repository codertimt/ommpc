...
void Button::init(Config& config)
{
	...
	SDL_Surface * tmpBack = IMG_Load(string("skins/icons/"+config.getItem(configItem)+"/"+m_name+"_back.png").c_str());
	...
	tmpBack = IMG_Load(string("skins/icons/"+config.getItem(configItem)+"/"+m_name+".png").c_str());
	if (!tmpBack) {
