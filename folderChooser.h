...
#ifndef __FOLDERCHOOSER_H__
#define __FOLDERCHOOSER_H__
...
class FolderChooser : public Scroller
{
public:
    ...
    FolderChooser(mpd_Connection* mpd, SDL_Surface* bg, SDL_Surface* screen, TTF_Font* font, SDL_Rect& rect, Config& config, int skipVal, int numPerScreen, SongDb& songdb, Keyboard& kb);
